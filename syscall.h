...
#define SYS_date SYS_halt + 1      // System call date
#define SYS_getuid SYS_date + 1    // System call get uid
#define SYS_getgid SYS_getuid + 1  // System call get gid
#define SYS_getppid SYS_getgid + 1 // System call get parent id
#define SYS_setuid SYS_getppid + 1 // System call set uid
#define SYS_setgid SYS_setuid + 1  // System call set gid
